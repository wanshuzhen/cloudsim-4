...
//			Switch router = new Switch("TP_LINK",1, datacenter0);
//			router.
			...
			NetworkCloudlet cloudlet1 = new NetworkCloudlet(id, length, pesNumber, fileSize, outputSize, 100, utilizationModel, utilizationModel, utilizationModel);

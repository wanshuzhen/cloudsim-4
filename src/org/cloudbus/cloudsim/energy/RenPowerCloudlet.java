...
public class RenPowerCloudlet extends Cloudlet{

	private Date requestDate = null;
	
	private double requestTime ;//请求时间和初始时间的时间差  而finishtime又是结束时间和初始时间的时间差
	
	public RenPowerCloudlet(final int cloudletId,final long cloudletLength, final int pesNumber, final long cloudletFileSize,

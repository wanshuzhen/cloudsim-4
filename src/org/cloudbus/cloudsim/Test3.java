...
public class Test3 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// create VM
			PowerVm vm = new PowerVm(vmid, brokerId, mips, pesNumber, ram, bw, size,0, vmm, new CloudletSchedulerTimeShared(),0);
	...
	private static PowerDatacenter createDatacenter(String name) {
		...
		hostList.add(
			new PowerHost(
				...
				storage,
				peList,
				new VmSchedulerTimeShared(peList),new PowerModelCubic(200, 70)
			)
		); // This is our machine
